...
rpc\+\_\+query\+\_\+set always tries to automatically add missing pieces of the provided path. Example\+: object = \{\} path = \char`\"{}some.\+0.\+values.\+1.\+and.\+indexes\char`\"{} value = true

result = \{some\+:\mbox{[}\{values\+:\mbox{[}null,\{and\+:\{indexes\+:true\}\}\mbox{]}\}\mbox{]}\}
