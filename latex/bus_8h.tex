...
typedef void($^\wedge$ {\bfseries rpc\+\_\+bus\+\_\+event\+\_\+handler\+\_\+t}) (rpc\+\_\+bus\+\_\+event\+\_\+t event, struct \hyperlink{structrpc__bus__node}{rpc\+\_\+bus\+\_\+node} $\ast$\+\_\+\+Nonnull node)
\end{DoxyCompactItemize}
...
{\footnotesize\ttfamily void rpc\+\_\+bus\+\_\+register\+\_\+event\+\_\+handler (\begin{DoxyParamCaption}\item[{\+\_\+\+Nonnull rpc\+\_\+bus\+\_\+event\+\_\+handler\+\_\+t}]{handler }\end{DoxyParamCaption})}
